                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="/projects">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="h-10 bg-white border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus: ring-0" id="title" name="title">
